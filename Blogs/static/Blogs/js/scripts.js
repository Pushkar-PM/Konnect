...
function start1(click){
    // var e=document.querySelector("#click");
    if(document.querySelector("."+('container2'+"-"+click)).classList.contains("active")){
        document.querySelector("."+('container2'+"-"+click)).classList.remove("active")
        document.querySelector("."+('container2'+"-"+click)).classList.add("inactive")

    }
    else{
        document.querySelector("."+('container2'+"-"+click)).classList.remove("inactive")
        var check=document.querySelector("."+('container2'+"-"+click)+"active");
        var e1=document.querySelector("."+('container2'+"-"+click));
        e1.classList.add('active');
